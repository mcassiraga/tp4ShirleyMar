...
const toggleModal = () => {
	// el comportamiento de los modales podría ser extraido para no duplicarlo por cada modal
...
const toggleEditModal = (id) => {
	...
	fetch(`/api/employee-db/${id}`).then((res) => res.json()).then((res) => fillEditModal(res))
}
